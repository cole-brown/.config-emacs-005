;;; taskspace/naming.el --- Naming Helpers -*- lexical-binding: t; -*-
;;
...
DESCRIPTION should be a string."
  ...
  (let* ((func/name "taskspace--naming-make")
         (func/tags '(:create))
         ...
         split-alist)
    (taskspace--debug func/name
      "args: group: %S date: %S number: %S description: %S --name-parts: %S --name-len: %S"
      group
      date
      number
      description

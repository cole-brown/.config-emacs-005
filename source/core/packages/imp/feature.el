...
Uses `imp--feature-replace-rx' to replace invalid characters in the INPUT
...
;; (imp--feature-name-normalize :foo)
;; (imp--feature-name-normalize 'test?-xx:y::z)
;; (imp--feature-name-normalize "+!@$%^&*|")


(defun imp--feature-normalize-string (&rest input)
...
Always returns a backwards list.
  Example:
    ...
    (imp--feature-normalize '(:foo bar) 'baz)
      -> '(\"baz\" \"bar\" \"foo\")"
  (let ((func/name "imp--feature-normalize-string")
        output)
...
;; (imp--feature-normalize-string 'test?-xx:y::z)
;; (imp--feature-normalize-string '+!@$%^&*|)
;; (imp--feature-normalize-string :imp 'test?-xx:y::z "+!@$%^&*|" 'symbols)
...
First symbol in output list will be a keyword; rest will be symbols.
  ...
  (let ((func/name "imp--feature-normalize")
        (strings/reversed (imp--feature-normalize-string input))
        output)
...
;;   (imp--feature-normalize (list feature)))
...
Similar output to `imp-feature-normalize-imp->emacs'."
  ...
  (intern (concat ":"
                  ...
                  (mapconcat #'identity
                             (nreverse (imp--feature-normalize-string feature))
                             imp--feature-replace-separator))))
;; (imp--feature-normalize-display '(:imp test symbols))
;; (imp--feature-normalize-display '(:imp test) 'symbols)
;; (imp--feature-normalize-display '(:imp provide))
;; (imp--feature-normalize-display :imp 'provide)
;; (imp--feature-normalize-display :imp)
;; (imp--feature-normalize-display '(((:imp))) '((provide)))
;; (imp--feature-normalize-display "foo/bar/baz.el")
...
Errors if:
  ...
  (let ((func/name "imp--feature-paths")
        (check (imp--feature-normalize feature:base feature)))
